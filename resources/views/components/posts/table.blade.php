            ...
            <div class="flex flex-col md:flex-row items-center justify-start space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form class="flex items-center"
                        ...
                        <label for="simple-search"
                               class="sr-only">Search post</label>
                ...
                <div
                    ...
                    <a href="/dashboard/create"
                       ...
                       data-modal-target="createProductModal-deactivate"
                       data-modal-toggle="createProductModal-deactivate"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col"
                            class="px-4 py-3">Category
                        </th>
                        <th scope="col"
                            class="px-4 py-3">Published At
                        </th>
                        <th scope="col"
                            class="px-4 py-3">
                    ...
                    @foreach($posts as $post)
                        <tr class="border-b dark:border-gray-700">
                            ...
                            {{--                            <td class="px-4 py-3 max-w-[12rem] truncate">{{ $post->author->name }}--}}
                            {{--                            </td>--}}
                                    ...
                                    <ul class="py-1 text-sm"
                                        ...
                                        <li>
                                            <a href="/dashboard/{{ $post->slug }}"
                                               data-modal-target="readProductModal-unused"
                                               data-modal-toggle="readProductModal-unused"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <dl>
                ...
                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Standard glass ,3.8GHz 8-core
                                                                                     ...
                                                                                     5.0GHz, 16GB 2666MHz DDR4 memory,
                                                                                     Radeon Pro 5500 XT with 8GB of
                                                                                     GDDR6 memory, 256GB SSD storage,
